...
function connexionBase()
{
   ...
   $host = "localhost:3306";
   $login= "alegris";     // Votre loggin d'accès au serveur de BDD 
   $password="19120al";    // Le Password pour vous identifier auprès du serveur
   $base = "alegris";    // La bdd avec laquelle vous voulez travailler 
